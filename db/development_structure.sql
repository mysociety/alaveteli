...
--
-- Name: exim_log_dones; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE exim_log_dones (
    id integer NOT NULL,
...
ALTER SEQUENCE exim_log_dones_id_seq OWNED BY exim_log_dones.id;


--
-- Name: exim_logs; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
ALTER SEQUENCE exim_logs_id_seq OWNED BY exim_logs.id;
...
ALTER TABLE exim_log_dones ALTER COLUMN id SET DEFAULT nextval('exim_log_dones_id_seq'::regclass);
...
ALTER TABLE exim_logs ALTER COLUMN id SET DEFAULT nextval('exim_logs_id_seq'::regclass);
...
ALTER TABLE ONLY exim_log_dones
...
CREATE INDEX index_exim_log_dones_on_last_stat ON exim_log_dones USING btree (last_stat);
...
CREATE INDEX index_exim_logs_on_exim_log_done_id ON exim_logs USING btree (exim_log_done_id);
...
--
-- Name: index_public_body_tags_on_name; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_public_body_tags_on_name ON has_tag_string_tags USING btree (name);


--
-- Name: index_public_body_tags_on_public_body_id_and_name_and_value; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX index_public_body_tags_on_public_body_id_and_name_and_value ON has_tag_string_tags USING btree (model_id, name, value);
...
ALTER TABLE ONLY exim_logs
    ADD CONSTRAINT fk_exim_log_done FOREIGN KEY (exim_log_done_id) REFERENCES exim_log_dones(id);
