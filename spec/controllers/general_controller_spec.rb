...
describe GeneralController, "when showing public body statistics" do
  ...
  it "should render the right template with the right data" do
    ...
    get :statistics
    expect(response).to render_template('general/statistics')
...
describe GeneralController, "when converting data for graphing" do
