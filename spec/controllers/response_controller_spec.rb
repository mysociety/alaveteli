...
describe ResponseController do
  ...
  describe "when viewing the followup form" do
  ...
  describe "when previewing a followup message" do
  ...
  describe "when sending the followup message" do
    ...
    it "redirects to the request page" do
      ...
      expect(response).to redirect_to(:action => 'show', :controller => 'request',
