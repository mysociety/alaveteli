...
describe AlaveteliPro::PlanWithDiscount do
  ...
  let(:subscription) { OpenStruct.new(plan: plan) }
  ...
  describe '#amount' do
    ...
    it 'applies a percentage discount correctly' do
      coupon = OpenStruct.new(id: "50_off", object: "coupon", amount_off: nil,
                              duration: "forever", max_redemptions: nil,
                              percent_off: 50, redeem_by: nil,
                              times_redeemed: 1, valid: true)
