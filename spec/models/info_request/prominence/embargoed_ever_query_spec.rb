...
RSpec.describe InfoRequest::Prominence::EmbargoedEverQuery do
  ...
  describe '#call' do
    ...
    it 'includes requests that have ever had an embargo' do
      is_expected.to include(embargoed_request, embargo_expired_request)
    end

    it 'excludes requests that have never had an embargo' do
      is_expected.not_to include(public_request)
    end
  end
end
