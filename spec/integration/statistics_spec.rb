...
describe "Site statistics" do
  ...
  describe "for public bodies" do
    it "should include all requests except hidden requests in the total count" do
      public_body = create(:public_body)
      create(:info_request, public_body: public_body)
      create(:info_request, public_body: public_body, prominence: "requester_only")
      create(:info_request, public_body: public_body, described_state: "successful")
