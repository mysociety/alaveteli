...
Това е кодът, задвижващ сайта [Питай ги](https://pitaigi.bg). Сайтът дава възможност да се правят електронни запитвания до институции по Закона за достъп до обществена информация (ЗДОИ). Проектът е реализиран и се поддържа от [фондация Общество.бг](http://www.obshtestvo.bg).
